...
<head>
    <meta charset="UTF-8">
    <title>Bogura District Upazila Quiz</title>
    <style>
...
<body>
    <div class="card">
        <h1>Bogura District Upazila Quiz</h1>
        <p>10 questions on the crops, geology, and educational institutions of Bogra Sadar, Shibganj, Sherpur, Sonatola, Dhunat, Gabtali, Sariakandi, Adamdighi, Kahaloo, Dupchanchia, Nandigram & Shajahanpur.</p>
